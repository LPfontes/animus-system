...
const dir = 'c:/Users/lpfon/Downloads/animus/animus-system/packs/_source/itens/Armas';
...
files.forEach(file => {
  ...
  // Se já tiver propriedades, mesclar ou substituir
  data.system.properties = props;

  // Limpar descrição de redundância se necessário, ou apenas deixar como está por enquanto
